...
var voters = [
  3, 6, 10, 12, 14, 23, 26, 30, 34, 37, 39, 42, 45, 48, 51, 54, 59, 61, 64, 67,
  72, 75, 78, 81, 84, 90, 93, 98, 102, 104, 108, 114, 117, 120, 124, 127, 130,
  134, 146, 149,
];
var votersVoted = [];
let votersVotedCheck = false;
...
showResult.addEventListener("click", () => {
  ...
  if (passingCode === "vegeta123") {
    ...
    let resultContent =
      `CR Elections Fall 2024 SP24-BS-SE-C\n\n` +
...
addVote.addEventListener("click", () => {
  ...
  if (code == "kakarot123") {
    ...
    votersVoted.forEach((val) => {
      if (val == newId) {
        votersVotedCheck = true;
      }
    });
    if (flag == true && votersVotedCheck == false) {
      voters.push(newId);
      totalVotes++;
      ...
      alert("You cant register as you already voted in the poll");
    }
  } else {
